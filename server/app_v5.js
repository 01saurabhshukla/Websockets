//  (1) extract the body (optional) of a closure frame (2) construct a closure frame and close the websocket connection (TCP connection)
...
class WebSocketReceiver {
    ...
    _getInfo() {
        ...
        // if data is not masked, then close the ws connection
        if(!this._masked) {
