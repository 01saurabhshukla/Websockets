// 🥅 (1) extract information from the WS frame received (2) calculate the exact payload size of our websocket frame (3) extracted the masking key (4) unmask the payload data for one particular frame
...
class WebSocketReceiver {
    ...
    _getPayload() {
        ...
        if (!this._fin) {
            ...
            this._task = SEND_ECHO; // still to complete
        };
